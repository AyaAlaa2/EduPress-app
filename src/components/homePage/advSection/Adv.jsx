...
const Adv = () => {
  return (
    <div className="w-full h-[324px] bg-linear-to-r from-teal-100 to-fuchsia-200 md:bg-[url(/advBackground.svg)] bg-cover bg-center flex flex-col items-start justify-center rounded-[20px] gap-6 px-[50px]">
      ...
      <div className="flex flex-col gap-5">
        ...
        <Button className="w-auto sm:w-[30%]">Explorer Course</Button>
      </div>
    </div>
  );
};
