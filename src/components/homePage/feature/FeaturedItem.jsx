  ...
  return (
    <div className="flex flex-col items-center justify-start overflow-hidden rounded-[20px] border border-1 border-[#EAEAEA] hover:shadow-lg hover:-translate-y-4 cursor-pointer transition-all duration-300 group h-[474px]">
      <div className="w-full h-[250px] relative">
        ...
        <img src={feature.Image} alt="course image" className="w-full h-full" />
      </div>
      <div className="w-full px-5  pt-5 flex flex-col items-start justify-center gap-3 mb-[16px]">
        <p className="text-md ">{feature.by}</p>
        ...
        <div className="flex justify-start items-center gap-4">
          ...
          <div className="flex gap-[5.3px] items-center">
            ...
            <span className="text-lg text-[#555555]">
              {feature.numOfStudent} strudents
            </span>
          </div>
        </div>
        <Separator />
        <div className="flex justify-between w-full items-center ">
          <p className="text-[#9D9D9D] text-[18px]">{feature.price}</p>
