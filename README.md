# EduPress — E-Learning Website

## Overview

**EduPress** is a modern e-learning platform built with **React.js (Vite)** as part of a university project.  
The platform aims to provide an intuitive and engaging online learning experience, allowing students to explore courses, track their progress, and access educational content seamlessly.
...
- **Login / Signup Pages** – Front-end only authentication interfaces (UI only, no backend logic).
...
- Browse and explore available courses through a clean and organized interface.
- Side filtering system on Courses and Blog pages for easier content navigation.
...
- Front-end only login and signup pages for UI/UX demonstration purposes.
- Toast notifications and alert modals for user feedback.
- Modern UI with reusable components and simple animations.
...
git clone https://github.com/AyaAlaa2/EduPress-app
